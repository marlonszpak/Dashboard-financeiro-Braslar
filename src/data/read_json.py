...
def get_json_data() -> pd.DataFrame: 
    ...
    pago_mes['Valor'] = pago_mes['Valor'].astype(float)
    ...
    pagar_mes['Valor'] = pagar_mes['Valor'].astype(float)
    ...
    recebido_mes['Valor'] = recebido_mes['Valor'].astype(float)
    ...
    receber_mes['Valor'] = receber_mes['Valor'].astype(float)
